                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-12">
                        <div class="md:col-span-4">
                            <a href="/" class="flex items-center gap-3 mb-6">
                                <img src="/logo.png" alt="Dartmark" class="w-10 h-10" />
                                <span class="text-xl font-display font-bold text-foreground">Dartmark</span>
                            </a>
                            <p class="text-muted-foreground mb-6! leading-relaxed">
                                Dartmark is a benchmarking platform for Dart and Flutter packages, helping developers make informed decisions about which packages to use in their projects.
                            </p>
